         ...
         <div class="container">
                 ...
                 <div class="d-flex py-3">
                     <h3>TotalPrice:UGX${(total>0)?total:0}</h3>
                           ...
                           <a href="/ShoplexEcommerce/CheckOut"class="mx-3 btn btn-primary">CompletePurchase</a>
                 </div>
...
<!--                             <th scope="col">BuyNow</th>-->
                     ...
                     <td><img src="/ShoplexEcommerce/images/<%=c.getImagesource()%>" height='150px' width="150px" alt=""></td>
                     ...
                     <td>
                         <form action="/ShoplexEcommerce/InsertData" method="post" class="form-inline">
                             ...
                             <div class="form-group d-flex justify-content-between w-50">
                                 ...
                                 <a class="btn btn-sm btn-incre" href="/ShoplexEcommerce/CheckButtons?action=inc&id=<%=c.getId()%>"><i class="fa fa-plus-square" aria-hidden="true"></i></a>
