          ...
          <div class="row g-0">
            <div class="col-lg-6">
                ...
                <div class="text-center">
                 ...
                 <form action="/ShoplexEcommerce/jsps/signin.jsp" method="GET">
                  ...
                  <div class="d-flex align-items-center justify-content-center pb-4">
                    ...
                    <button type="button" class="btn btn-outline-danger">Sign up</button>
                     ...
                     <% email=request.getParameter("email");
                       ...
                       String Query1="Select email,Password from customer where email=? and Password=?";
                       PreparedStatement pst = conn.prepareStatement(Query1);
                       pst.setString(1,email);
                       pst.setString(2,password);
                       ResultSet rs =pst.executeQuery();
                          // st =conn.createStatement();
                          //String Query1 ="SELECT Password,email from customer where"+" email="+"'"+email+"'"+"\t"+"and password="+"'"+password+"'"+";";
                         // ResultSet res= st.executeQuery(Query1);
               while(rs.next()){
             
          ep=rs.getString("password");
